...
#$page->title       = "Blogs";
#$page->description = "Articles and comments from church leaders and members";
#$page->header      = "Blogs";
#$page->content     = <<<EOF
...
$blog->page->description = "Articles and comments from church leaders and members.";
$blog->page->header      = "Blogs";
$blog->run();
